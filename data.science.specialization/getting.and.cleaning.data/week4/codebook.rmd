...
activity - the activity the subject was performing when the given measurements were taken.
subjectid - the id of a given subject from which the data was collected. 
...
The numerical features selected for this database come from the accelerometer and gyroscope 3-axial raw signals tAcc-XYZ and
...
The variables are the average of measurements by subjectid and activity
